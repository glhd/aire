<div class="flex-no-shrink pr-8">
	...
	<ul class="list-reset mt-8">
		...
		<li>
			<a href="{{ url('/') }}#intro" class="text-grey-darker no-underline font-semibold text-lg hover:underline">
				Introduction
			</a>
		</li>
		
		<li>
			<a href="{{ url('/') }}#demo" class="text-grey-darker no-underline font-semibold text-lg hover:underline">
				Basic Demo
			</a>
		</li>
